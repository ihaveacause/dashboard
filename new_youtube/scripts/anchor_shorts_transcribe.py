...
Propose exactly THREE titles, as a JSON array of 3 objects, each:
...
Rules:
- Return TWO "punchy" titles (hook-first, curiosity-driven, built for a fast
  vertical swipe feed) and ONE "descriptive" title (a clean, accurate summary).
